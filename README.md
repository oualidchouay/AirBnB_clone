...
------------------------------------------------------
### 11\. CAll instances by class name
...
Update your command interpreter (`console.py`) to retrieve all the number of instances of a class: `<class name>.count()`.
...
Update your command interpreter (`console.py`), all features!
...
[Click here to tweet!](https://twitter.com/intent/tweet?text=I+have+successfully+completed+my+AirBnB+Console+project+on+%23ALX_SE+%40facesofalxse "Click here to tweet!")
